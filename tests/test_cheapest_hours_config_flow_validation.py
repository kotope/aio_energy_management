...
class TestValidateBasicIntegerFields:
    ...
    def test_valid_typical(self):
        errors = validate_basic_integer_fields(self._make_input(0, 23, 4))
        assert not errors

    def test_valid_first_hour_boundary_low(self):
        errors = validate_basic_integer_fields(self._make_input(0, 23, 1))
        assert not errors

    def test_valid_first_hour_boundary_high(self):
        errors = validate_basic_integer_fields(self._make_input(23, 23, 1))
        assert not errors

    def test_valid_last_hour_equals_first_hour(self):
        errors = validate_basic_integer_fields(self._make_input(10, 10, 1))
        assert not errors

    def test_valid_number_of_slots_zero(self):
        # 0 is allowed (use entity instead)
        errors = validate_basic_integer_fields(self._make_input(0, 23, 0))
        assert not errors

    def test_valid_number_of_slots_large(self):
        errors = validate_basic_integer_fields(self._make_input(0, 23, 96))
        assert not errors

    def test_missing_fields_no_errors(self):
        # Fields that are None (omitted) should not raise errors
        errors = validate_basic_integer_fields({})
        assert not errors

    # --- first_hour ---

    def test_invalid_first_hour_too_high(self):
        errors = validate_basic_integer_fields(self._make_input(24, 23, 1))
    ...
    def test_invalid_first_hour_negative(self):
        errors = validate_basic_integer_fields(self._make_input(-1, 23, 1))
        assert CONF_FIRST_HOUR in errors
        assert errors[CONF_FIRST_HOUR] == "first_hour_out_of_range"
    ...
    def test_invalid_last_hour_too_high(self):
        errors = validate_basic_integer_fields(self._make_input(0, 24, 1))
    ...
    def test_invalid_last_hour_negative(self):
        errors = validate_basic_integer_fields(self._make_input(0, -1, 1))
        assert CONF_LAST_HOUR in errors
        assert errors[CONF_LAST_HOUR] == "last_hour_out_of_range"
    ...
    def test_valid_last_hour_before_first_hour_overnight_window(self):
        ...
        errors = validate_basic_integer_fields(self._make_input(22, 6, 1))
        assert not errors
    ...
    def test_last_hour_out_of_range_not_reported_as_before_first_hour(
        ...
        errors = validate_basic_integer_fields(self._make_input(10, 25, 1))
        assert errors[CONF_LAST_HOUR] == "last_hour_out_of_range"
    ...
    def test_first_hour_out_of_range_does_not_prevent_last_hour_range_check(
        ...
        errors = validate_basic_integer_fields(self._make_input(25, 5, 1))
        assert CONF_FIRST_HOUR in errors
...
class TestValidateAdvancedIntegerFields:
    """Tests for validate_advanced_integer_fields."""

    # --- valid cases ---

    def test_valid_no_fields_set(self):
        errors = validate_advanced_integer_fields({})
        assert not errors

    def test_valid_failsafe_low_boundary(self):
        errors = validate_advanced_integer_fields({CONF_FAILSAFE_STARTING_HOUR: 0})
        assert not errors

    def test_valid_failsafe_high_boundary(self):
        errors = validate_advanced_integer_fields({CONF_FAILSAFE_STARTING_HOUR: 23})
        assert not errors

    def test_valid_trigger_hour(self):
        errors = validate_advanced_integer_fields({CONF_TRIGGER_HOUR: 12})
        assert not errors
    ...
    def test_invalid_failsafe_too_high(self):
        errors = validate_advanced_integer_fields({CONF_FAILSAFE_STARTING_HOUR: 24})
    ...
    def test_invalid_failsafe_negative(self):
        errors = validate_advanced_integer_fields({CONF_FAILSAFE_STARTING_HOUR: -1})
        assert CONF_FAILSAFE_STARTING_HOUR in errors

    # --- trigger_hour ---

    def test_invalid_trigger_hour_too_high(self):
        errors = validate_advanced_integer_fields({CONF_TRIGGER_HOUR: 24})
    ...
    def test_invalid_trigger_hour_negative(self):
        errors = validate_advanced_integer_fields({CONF_TRIGGER_HOUR: -1})
        assert CONF_TRIGGER_HOUR in errors
...
class TestValidateOffsetIntegerFields:
    """Tests for validate_offset_integer_fields."""
    ...
    def test_valid_no_fields_set(self):
        errors = validate_offset_integer_fields({})
        assert not errors

    def test_valid_start_minutes_boundaries(self):
        assert not validate_offset_integer_fields({self.START_MINUTES: 0})
        assert not validate_offset_integer_fields({self.START_MINUTES: 59})

    def test_valid_end_minutes_boundaries(self):
        assert not validate_offset_integer_fields({self.END_MINUTES: 0})
        assert not validate_offset_integer_fields({self.END_MINUTES: 59})
    ...
    def test_invalid_start_minutes_too_high(self):
        errors = validate_offset_integer_fields({self.START_MINUTES: 60})
    ...
    def test_invalid_end_minutes_too_high(self):
        errors = validate_offset_integer_fields({self.END_MINUTES: 60})
...
class TestValidateAndBuildAddFlexible:
    """Tests for validate_and_build_add_flexible."""
    ...
    def test_valid_static_builds_nested_dict(self):
        ...
        errors = validate_and_build_add_flexible(user_input, 60)
        assert not errors
    ...
    def test_max_within_cap_15(self):
        ...
        errors = validate_and_build_add_flexible(user_input, 15)
        assert not errors
