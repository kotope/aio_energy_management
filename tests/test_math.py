...
@pytest.mark.parametrize(
    "first_hour, last_hour, pass_tomorrow, expect_raise, test_id",
    [
        # CONFIGURATION 1: Regular window during day, no overnight hours
        (7, 19, True, False, "time_window_with_tomorrow"),
        (7, 19, False, False, "time_window_without_tomorrow"),
        # CONFIGURATION 2: Regular window during day, with overnight hours
        (22, 21, True, False, "overnight_window_with_tomorrow"),
        (22, 21, False, True, "overnight_window_without_tomorrow_must_fail"),
    ],
)
def test_cheapest_hours_scenarios(
    ...
    starting_today = last_hour < first_hour
